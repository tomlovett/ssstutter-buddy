    ...
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900">Welcome to SSStutterBuddy</h1>
          ...
          <div className="mt-8 text-left max-w-3xl mx-auto">
            <p className="text-gray-600">
              ...
              funding, research ideas, even technology — it's finding enough PWS to participate in the study!
            </p>
            <p className="mt-4 text-gray-600">
              If you or your child have a stutter, <b>you can support hard-working researchers</b> as they
              advance our knowledge of stuttering's causes, expression, and treatment by particiating in
              studies.
            </p>
            <p className="mt-4 text-gray-600">
            ...
            <p className="mt-4 text-gray-600">
              ...
              money, <b>we're here to make a difference</b>
            </p>
