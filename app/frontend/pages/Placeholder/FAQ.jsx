          ...
          <div className="mt-8 max-w-3xl mx-auto">
            <Accordion type="single" collapsible>
              ...
              <AccordionItem value="mydata">
                ...
                <AccordionContent className="px-4 pb-5">
                  <p className="text-gray-600 whitespace-pre-line text-left">
                    A researcher will not be able to see any information about
                    you unless you express interest in one of their studies.
                    <br />
                    <br />
              ...
              <AccordionItem value="money">
                ...
                <AccordionContent className="px-4 pb-5">
                  <p className="text-gray-600 whitespace-pre-line text-left">
                    ...
                    SSStutterBuddy does not take any of the compensation given
                    to study participants, nor does it charge researchers for
                    posting studies.
                    <br />
                    <br />
                    Our mission is to help advance stuttering research. As such,
                    we feel that any money earmarked for research should go
                    either towards the participants or the study itself, not a
              ...
              <AccordionItem value="costs">
                ...
                <AccordionContent className="px-4 pb-5">
                  <p className="text-gray-600 whitespace-pre-line text-left">
                    ...
                    Other tech professionals have also donated their time to
                    ...
                    , send an email to tom at tomlovett dot com. Technical
                    skills are preferred, but anyone can help!
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="location">
                ...
                <AccordionContent className="px-4 pb-5">
                  <p className="text-gray-600 whitespace-pre-line text-left">
                    <span className="font-semibold">Yes!</span> SSStutterBuddy
                    is available for PWS and researchers all over the world. Our
                    location-matching algorithm services 251 different
                    countries!
                    <br />
                    <br />
              ...
              <AccordionItem value="compensation">
                ...
                <AccordionContent className="px-4 pb-5">
                  <p className="text-gray-600 whitespace-pre-line text-left">
                    Most institutions require that researchers <i>give</i> you
                    the advertised remuneration. That said, you may have to take
                    it but you don't have to keep it.
                    <br />
                    <br />
